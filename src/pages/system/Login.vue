 ...
 * @LastEditTime: 2025-01-17 14:56:15
    ...
    <div class="login-container col row">
      ...
      <div class="oath flex">
        ...
        <div class="q-gutter-md full-width text-center q-pt-sm flex justify-center">
          ...
          <!-- <button @click="handleOAuthLogin('facebook')">
            <svg
              fill="#000000"
              width="36px"
              height="36px"
          ...
          <button @click="handleOAuthLogin('linkedin_oidc')">
            <svg
              id="Layer_1"
              fill="#000000"
              height="36px"
...
import { useAccountStore } from '@src/store/system/account'
