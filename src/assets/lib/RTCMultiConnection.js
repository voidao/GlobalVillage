...
var RTCMultiConnection = function (roomid, forceOptions) {
    ...
    function onMessageEvent(message) {
      ...
      if (message.message.newParticipationRequest && message.sender !== connection.userid) {
        ...
        var userPreferences = {
          ...
          isDataOnly:
            typeof message.message.isDataOnly !== 'undefined' ? message.message.isDataOnly : isData(connection.session),
          dontGetRemoteStream:
            typeof message.message.isOneWay !== 'undefined'
              ? message.message.isOneWay
              : !!connection.session.oneway || connection.direction === 'one-way',
  ...
  function MultiPeers(connection) {
    ...
    this.onDataChannelMessage = function (message, remoteUserId) {
      textReceiver.receive(
        JSON.parse(message),
        remoteUserId,
        connection.peers[remoteUserId] ? connection.peers[remoteUserId].extra : {}
      )
    }
  ...
  ;(function () {
    ...
    ;['RTCPeerConnection', 'webkitRTCPeerConnection', 'mozRTCPeerConnection', 'RTCIceGatherer'].forEach(
      function (item) {
    ...
    if (
      ...
      typeof mozRTCPeerConnection !== 'undefined' /*&& DetectRTC.browser.version > 39*/
    ) {
  ...
  function isUnifiedPlanSuppored() {
    ...
    try {
      ...
      try {
        ...
        if (config.sdpSemantics == 'unified-plan') isUnifiedPlanSupported = true
        else if (config.sdpSemantics == 'plan-b') isUnifiedPlanSupported = false
  ...
  var CodecsHandler = (function () {
    ...
    function setOpusAttributes(sdp, params) {
      ...
      appendOpusNext +=
        '; sprop-stereo=' + (typeof params['sprop-stereo'] != 'undefined' ? params['sprop-stereo'] : '1')
    ...
    function handle(connection) {
      ...
      connection.Translator = {
        ...
        getListOfLanguages: function (callback) {
          ...
          var url =
            'https://www.googleapis.com/language/translate/v2/languages?key=' + connection.googKey + '&target=en'
  ...
  ;(function (connection) {
    ...
    mPeer.onGettingLocalMedia = function (stream, callback) {
      ...
      getRMCMediaElement(
        ...
        function (mediaElement) {
          ...
          var isAudioMuted =
            stream.getAudioTracks().filter(function (track) {
    ...
    connection.join = function (remoteUserId, options) {
      connection.sessionid =
        (remoteUserId ? remoteUserId.sessionid || remoteUserId.remoteUserId || remoteUserId : false) ||
        connection.sessionid
      connection.sessionid += ''
    ...
    function joinRoom(connectionDescription, cb) {
      connection.socket.emit(
        'join-room',
        {
          ...
          extra: connection.extra,
          password:
            typeof connection.password !== 'undefined' && typeof connection.password !== 'object'
              ? connection.password
              : ''
        },
